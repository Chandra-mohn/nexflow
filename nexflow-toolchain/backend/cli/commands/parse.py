...
MODULARIZATION: Graph conversion logic extracted to graph_converter.py
"""
...
from .graph_converter import ast_to_graph
...
# Graph conversion functions extracted to graph_converter.py
# ast_to_graph is imported at the top of the file
