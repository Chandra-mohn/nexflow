...
from backend.generators.common.java_utils import (
    ...
    # Template utilities
    generate_java_header as _generate_java_header,
    generate_package_declaration as _generate_package_declaration,
    generate_imports as _generate_imports,
    indent as _indent,
)
...
class BaseGenerator(ABC):
    ...
    def to_java_class_name(self, name: str) -> str:
        ...
        Delegates to java_utils.to_pascal_case() for single source of truth.
        """
    ...
    def to_java_field_name(self, name: str) -> str:
        ...
        Delegates to java_utils.to_camel_case() for single source of truth.
        """
    ...
    def to_java_constant_name(self, name: str) -> str:
        ...
        Delegates to java_utils.to_constant() for single source of truth.
        """
    ...
    def indent(self, code: str, level: int = 1, indent_str: str = "    ") -> str:
        """Indent a block of code. Delegates to java_utils."""
        return _indent(code, level, indent_str)
    ...
    def generate_java_header(self, class_name: str, description: str = "") -> str:
        """Generate standard Java file header. Delegates to java_utils."""
        return _generate_java_header(class_name, description, self.__class__.__name__) + '\n'

    def generate_package_declaration(self, package: str) -> str:
        """Generate Java package declaration. Delegates to java_utils."""
        return _generate_package_declaration(package)

    def generate_imports(self, imports: List[str]) -> str:
        """Generate sorted, deduplicated import statements. Delegates to java_utils."""
        return _generate_imports(imports)
