...
class SourceGeneratorMixin(SourceProjectionMixin, SourceCorrelationMixin):
    ...
    def _generate_source(self, receive: ast.ReceiveDecl, process: ast.ProcessDefinition) -> str:
        ...
        if connector_type == ast.ConnectorType.REDIS:
            ...
            # Default: Kafka source (handles timestamp bounds for bounded reads)
    ...
    # =========================================================================
    # v0.8.0+ Source Generators: Parquet and CSV
    # =========================================================================
    ...
    def _generate_parquet_source(self, receive: ast.ReceiveDecl, process: ast.ProcessDefinition) -> str:
        ...
        schema_path = parquet_config.schema_path if parquet_config else None
        ...
        lines.extend([
            f"FileSource<{schema_class}> {self._to_camel_case(source_name)}Source = FileSource",
    ...
    def _generate_csv_source(self, receive: ast.ReceiveDecl, process: ast.ProcessDefinition) -> str:
        ...
        escape_char = csv_config.escape_char if csv_config else "\\\\"
    ...
    def _get_effective_serialization(
        ...
        if requested_format is None and hasattr(self, '_serialization_config') and self._serialization_config:
            ...
            schema_format = requested_format
