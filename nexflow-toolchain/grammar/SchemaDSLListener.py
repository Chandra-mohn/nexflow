...
class SchemaDSLListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SchemaDSLParser#importStatement.
    def enterImportStatement(self, ctx:SchemaDSLParser.ImportStatementContext):
        pass

    # Exit a parse tree produced by SchemaDSLParser#importStatement.
    def exitImportStatement(self, ctx:SchemaDSLParser.ImportStatementContext):
        pass


    # Enter a parse tree produced by SchemaDSLParser#importPath.
    def enterImportPath(self, ctx:SchemaDSLParser.ImportPathContext):
        pass

    # Exit a parse tree produced by SchemaDSLParser#importPath.
    def exitImportPath(self, ctx:SchemaDSLParser.ImportPathContext):
        pass


    # Enter a parse tree produced by SchemaDSLParser#importPathSegment.
    def enterImportPathSegment(self, ctx:SchemaDSLParser.ImportPathSegmentContext):
        pass

    # Exit a parse tree produced by SchemaDSLParser#importPathSegment.
    def exitImportPathSegment(self, ctx:SchemaDSLParser.ImportPathSegmentContext):
        pass


    # Enter a parse tree produced by SchemaDSLParser#importFileExtension.
    def enterImportFileExtension(self, ctx:SchemaDSLParser.ImportFileExtensionContext):
        pass

    # Exit a parse tree produced by SchemaDSLParser#importFileExtension.
    def exitImportFileExtension(self, ctx:SchemaDSLParser.ImportFileExtensionContext):
        pass
    ...
    # Enter a parse tree produced by SchemaDSLParser#serializationBlock.
    def enterSerializationBlock(self, ctx:SchemaDSLParser.SerializationBlockContext):
        pass

    # Exit a parse tree produced by SchemaDSLParser#serializationBlock.
    def exitSerializationBlock(self, ctx:SchemaDSLParser.SerializationBlockContext):
        pass


    # Enter a parse tree produced by SchemaDSLParser#serializationDecl.
    def enterSerializationDecl(self, ctx:SchemaDSLParser.SerializationDeclContext):
        pass

    # Exit a parse tree produced by SchemaDSLParser#serializationDecl.
    def exitSerializationDecl(self, ctx:SchemaDSLParser.SerializationDeclContext):
        pass


    # Enter a parse tree produced by SchemaDSLParser#formatDecl.
    def enterFormatDecl(self, ctx:SchemaDSLParser.FormatDeclContext):
        pass

    # Exit a parse tree produced by SchemaDSLParser#formatDecl.
    def exitFormatDecl(self, ctx:SchemaDSLParser.FormatDeclContext):
        pass


    # Enter a parse tree produced by SchemaDSLParser#serializationFormat.
    def enterSerializationFormat(self, ctx:SchemaDSLParser.SerializationFormatContext):
        pass

    # Exit a parse tree produced by SchemaDSLParser#serializationFormat.
    def exitSerializationFormat(self, ctx:SchemaDSLParser.SerializationFormatContext):
        pass


    # Enter a parse tree produced by SchemaDSLParser#serializationCompatibilityDecl.
    def enterSerializationCompatibilityDecl(self, ctx:SchemaDSLParser.SerializationCompatibilityDeclContext):
        pass

    # Exit a parse tree produced by SchemaDSLParser#serializationCompatibilityDecl.
    def exitSerializationCompatibilityDecl(self, ctx:SchemaDSLParser.SerializationCompatibilityDeclContext):
        pass


    # Enter a parse tree produced by SchemaDSLParser#subjectDecl.
    def enterSubjectDecl(self, ctx:SchemaDSLParser.SubjectDeclContext):
        pass

    # Exit a parse tree produced by SchemaDSLParser#subjectDecl.
    def exitSubjectDecl(self, ctx:SchemaDSLParser.SubjectDeclContext):
        pass


    # Enter a parse tree produced by SchemaDSLParser#registryDecl.
    def enterRegistryDecl(self, ctx:SchemaDSLParser.RegistryDeclContext):
        pass

    # Exit a parse tree produced by SchemaDSLParser#registryDecl.
    def exitRegistryDecl(self, ctx:SchemaDSLParser.RegistryDeclContext):
        pass
