...
class SchemaDSLVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by SchemaDSLParser#importStatement.
    def visitImportStatement(self, ctx:SchemaDSLParser.ImportStatementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SchemaDSLParser#importPath.
    def visitImportPath(self, ctx:SchemaDSLParser.ImportPathContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SchemaDSLParser#importPathSegment.
    def visitImportPathSegment(self, ctx:SchemaDSLParser.ImportPathSegmentContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SchemaDSLParser#importFileExtension.
    def visitImportFileExtension(self, ctx:SchemaDSLParser.ImportFileExtensionContext):
        return self.visitChildren(ctx)
