...
class TestRouteConditionCompilation:
    ...
    def test_nested_field_path(self):
        ...
        assert "getCustomer().getStatus()" in result
    ...
    def test_complex_condition(self):
        ...
        assert "||" in result
        assert "getAmount()" in result
        assert "getCustomer().getTier()" in result
        assert "getRiskScore()" in result
